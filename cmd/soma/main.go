...
func main() {
	...
	//TODO router.GET(`/category/:category`, Check(BasicAuth(ShowCategory)))
	//TODO router.GET(`/category/`, Check(BasicAuth(ListCategory)))
	...
	//XXX router.GET(`/permission/:permission`, Check(BasicAuth(ShowPermission)))
	//XXX router.GET(`/permission/`, Check(BasicAuth(ListPermission)))
	//TODO router.GET(`/category/:category/permissions/:permission`)
	//TODO router.GET(`/category/:category/permissions/`)
	...
	//TODO router.GET(`/sections/`)
	//TODO router.GET(`/sections/:section`)
	//TODO router.GET(`/sections/:section/actions/`)
	//TODO router.GET(`/sections/:section/actions/:action`)
	...
	//TODO router.POST(`/filter/permission/`, Check(BasicAuth(SearchPermission)))
	...
	//TODO router.POST(`/filter/sections/`)
	//TODO router.POST(`/filter/actions/`)
	...
	if !SomaCfg.ReadOnly {
		...
		if !SomaCfg.Observer {
			...
			//TODO router.DELETE(`/category/:category`, Check(BasicAuth(DeleteCategory)))
			...
			//XXX router.DELETE(`/grant/global/:rtyp/:rid/:grant`, Check(BasicAuth(RevokeGlobalRight)))
			//XXX router.DELETE(`/grant/limited/:rtyp/:rid/:scope/:uuid/:grant`, Check(BasicAuth(RevokeLimitedRight)))
			//XXX router.DELETE(`/grant/system/:rtyp/:rid/:grant`, Check(BasicAuth(RevokeSystemRight)))
			//TODO router.DELETE(`/category/:category/permissions/:permission/grant/:grant`)
			...
			//XXX router.DELETE(`/permission/:permission`, Check(BasicAuth(DeletePermission)))
			//TODO router.DELETE(`/category/:category/permissions/:permission`, Check(BasicAuth(DeletePermission)))
			...
			//TODO router.DELETE(`/sections/:section`)
			//TODO router.DELETE(`/sections/:section/actions/:action`)
			...
			//TODO router.PATCH(`/category/:category/permissions/:permission`, PermissionEdit)
			...
			//TODO router.POST(`/category/`, Check(BasicAuth(AddCategory)))
			...
			//XXX router.POST(`/grant/global/:rtyp/:rid/`, Check(BasicAuth(GrantGlobalRight)))
			//XXX router.POST(`/grant/limited/:rtyp/:rid/:scope/:uuid/`, Check(BasicAuth(GrantLimitedRight)))
			//XXX router.POST(`/grant/system/:rtyp/:rid/`, Check(BasicAuth(GrantSystemRight)))
			//TODO //router.POST(`/category/:category/permissions/:permission/grant/`)
			...
			//XXX router.POST(`/permission/`, Check(BasicAuth(AddPermission)))
			//TODO router.POST(`/category/:category/permissions/`)
			...
			//TODO router.POST(`/sections/`)
			//TODO router.POST(`/sections/:section/actions/`)
