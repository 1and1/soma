...
var svGlobalRequiredPermission = map[string][]string{
	...
	`property_service_global_list`:   []string{`system_all`, `global_schema`},
	`property_service_global_search`: []string{`system_all`, `global_schema`},
	`property_service_global_show`:   []string{`system_all`, `global_schema`},
